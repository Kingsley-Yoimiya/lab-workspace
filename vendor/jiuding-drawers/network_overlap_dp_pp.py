...
if __name__ == "__main__":
    ...
    # ft4_y = [0, 0.1]
    ydata = [
        [36.15, 48.58, 22.11, 47.46, "Groundtruth"],
        [36.80, 48.53, 21.86, 47.52, "HyperSim"],
    ]
    ...
    ax.set_xticklabels(x_labels, fontsize=20, rotation=15)
    ...
    plt.tight_layout()
    plt.savefig('./output/network_overlap_dp_pp.pdf')
