...
if __name__ == "__main__":
    ...
    line_data = [
        [6800, 13600, 27200, "HyperSim"],
        [467614895842 ,1849645798565, 12430707336484, "SimAI"],
        [4536722838, 8987317031, 18397608646, "Astra-Sim"],
    ]
