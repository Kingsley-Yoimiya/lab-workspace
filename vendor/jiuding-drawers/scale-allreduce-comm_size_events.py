...
if __name__ == "__main__":
    ...
    line_data = [
        [27200, 27200, 27200, "HyperSim"],
        [5985256629676, 12430707336484, 24689965337865, "SimAI"],
        [9130524786, 18397608646, 36516199536, "Astra-Sim"],
    ]
    ...
    for idx in range(0, len(line_data)):
        # 计算x位置（与柱状图保持一致）
        x_positions = np.arange(len(line_data))
        ...
        #     if y > 0:
        #         # 使用工程格式显示
        #         # formatted_text = f"{y:.1e}".replace("e", r" \times 10^{") + "}$"
        #         formatted_text = sci_formatter(y)
