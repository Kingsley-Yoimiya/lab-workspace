...
if __name__ == "__main__":
    ...
    x_labels = ["128", "256", "512", "1024", "2048", "4096", "8192", "16394"]
    line_data = [
        [220+32.92, 224+3.7, 229+1.87, 232.3+0.91, 237.4+1.44, 242.7+0.17, 246.47+0.103, 253+0.05, "TP8+PP16"],
    ...
    plt.tight_layout()
    plt.savefig('./output/scale_end-to-end_dense_big.pdf')
    plt.show()