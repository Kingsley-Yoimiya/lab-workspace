...
export RUN_DIR=/afs-a3-241ceshi-shared/montyyin/results/exp45_parallel/20260713_113423/exp3_rank_inject LOG_DIR=/afs-a3-241ceshi-shared/montyyin/results/exp45_parallel/20260713_113423/exp3_rank_inject/
export TENSORBOARD_DIR=/afs-a3-241ceshi-shared/montyyin/results/exp45_parallel/20260713_113423/exp3_rank_inject/tb CKPT_SAVE_DIR=/afs-a3-241ceshi-shared/montyyin/results/exp45_parallel/20260713_113423/exp3_rank_inject/ckpt
...
bash /afs-a3-241ceshi-shared/montyyin/lab-workspace/scripts/cluster/wrappers/train_qwen3_8B_ascend.sh 2>&1 | tee /afs-a3-241ceshi-shared/montyyin/results/exp45_parallel/20260713_113423/exp3_rank_inject/rank0.log
rc=${PIPESTATUS[0]}
echo TRAIN_RANK_0_DONE rc=$rc | tee -a /afs-a3-241ceshi-shared/montyyin/results/exp45_parallel/20260713_113423/exp3_rank_inject/rank0.log
exit $rc
