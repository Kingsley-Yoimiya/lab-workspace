...
![radar host median norm](constitution_extra_20260711_figs/radar_host_median_norm.png)

### parallel host median norm

![parallel host median norm](constitution_extra_20260711_figs/parallel_host_median_norm.png)

### hbm modes grouped bar

![hbm modes grouped bar](constitution_extra_20260711_figs/hbm_modes_grouped_bar.png)

### corr cube vector sfu mte

![corr cube vector sfu mte](constitution_extra_20260711_figs/corr_cube_vector_sfu_mte.png)

### box launch by host

![box launch by host](constitution_extra_20260711_figs/box_launch_by_host.png)

### cdf core metrics

![cdf core metrics](constitution_extra_20260711_figs/cdf_core_metrics.png)

### extreme10 small multiples

![extreme10 small multiples](constitution_extra_20260711_figs/extreme10_small_multiples.png)

### heatmap host device vector gflops

![heatmap host device vector gflops](constitution_extra_20260711_figs/heatmap_host_device_vector_gflops.png)

### heatmap host device mte gbps

![heatmap host device mte gbps](constitution_extra_20260711_figs/heatmap_host_device_mte_gbps.png)

### heatmap host device sfu gflops

![heatmap host device sfu gflops](constitution_extra_20260711_figs/heatmap_host_device_sfu_gflops.png)

### heatmap host device scalar elems per s

![heatmap host device scalar elems per s](constitution_extra_20260711_figs/heatmap_host_device_scalar_elems_per_s.png)

### scatter sustained vs func

![scatter sustained vs func](constitution_extra_20260711_figs/scatter_sustained_vs_func.png)
